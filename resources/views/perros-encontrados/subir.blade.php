...
@section('content')
<h1>Subir perro encontrado</h1>

<div class="row">
        	<div class="col-lg-6">
        		{!! Form::open(['url'=>'subir-encontrado','files' => true]) !!}
                        
        			<h5>Los campos marcados con <span class="fld_req">*</span> son requeridos.</h5>
        			<h3>¿Dónde lo encontraste?</h3>
        			...
        			<div class="form-group">
        				...
        				<div class="help-block with-errors"></div>
                                ...
                                <div class="form-group">
                                {!! Form::label('encontrado_el', 'Se perdio el:') !!}
                                {!! Form::input('date','encontrado_el',date('Y-m-d'),['class'=>'form-control']) !!}
        			</div>
                                <div class="form-group">
